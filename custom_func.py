...
def custom_response_text_rewriter(raw_text, content_mime, remote_url):
	...
	'files.yqt365.com//logo/20170803092821201.jpg', 'okfw.net/mfyq_logo')
...
"> 监测概述 </span>
    ...
    display: block;
    float: left;
"><i class="fa-24-hours-news" style="font-size: 26px;top: -4px;position: absolute;left: 5px;font-weight: 500;"></i>全网新增<span class="item-number" id="summaryTotal" style="width: 20px;width: 20px;font-size: 16px;font-weight: 600;letter-spacing: .03em;color: red;margin: 0 5px;">0</span>条</span> <span class="sensitive-news" style="
    font-size: 14px;
    padding-left: 32px;
    position: relative;
    display: block;
...
"><i class="fa-send-warning" style="
    ...
    left: 5px;
    font-weight: 500;
"></i>微博新增<span class="item-number" id="summaryWbTotal" style="width: 20px;width: 20px;font-size: 16px;font-weight: 600;letter-spacing: .03em;color: red;margin: 0 5px;">0</span>条</span>
		</span>
	</div>
